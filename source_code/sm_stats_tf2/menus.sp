		...
		case MenuAction_Select:
		{
			...
			switch(results != null && results.FetchRow())
			{
				...
				case true:
				{
					...
					g_Player[client].top10[Stats_Points] = results.FetchInt(1);
					g_Player[client].top10[Stats_Frags] = results.FetchInt(2);
					g_Player[client].top10[Stats_Assists] = results.FetchInt(3);
					g_Player[client].top10[Stats_Deaths] = results.FetchInt(4);
					g_Player[client].top10[Stats_Suicides] = results.FetchInt(5);
					g_Player[client].top10[Stats_DamageDone] = results.FetchInt(6);
					g_Player[client].top10[Stats_Achievements] = results.FetchInt(7);
					
					g_Player[client].top10[Stats_Dominations] = results.FetchInt(8);
					g_Player[client].top10[Stats_Revenges] = results.FetchInt(9);
					g_Player[client].top10[Stats_Airshots] = results.FetchInt(10);
					g_Player[client].top10[Stats_Headshots] = results.FetchInt(11);
					g_Player[client].top10[Stats_Noscopes] = results.FetchInt(12);
					g_Player[client].top10[Stats_Backstabs] = results.FetchInt(13);
					g_Player[client].top10[Stats_TauntFrags] = results.FetchInt(14);
					g_Player[client].top10[Stats_GibFrags] = results.FetchInt(15);
					g_Player[client].top10[Stats_Deflects] = results.FetchInt(16);
					g_Player[client].top10[Stats_TeleFrags] = results.FetchInt(17);
					g_Player[client].top10[Stats_Collaterals] = results.FetchInt(18);
					g_Player[client].top10[Stats_MidAirFrags] = results.FetchInt(19);
					g_Player[client].top10[Stats_CritFrags] = results.FetchInt(20);
					g_Player[client].top10[Stats_MiniCritFrags] = results.FetchInt(21);
					
					g_Player[client].top10[Stats_ScoutFrags] = results.FetchInt(22);
					g_Player[client].top10[Stats_SoldierFrags] = results.FetchInt(23);
					g_Player[client].top10[Stats_PyroFrags] = results.FetchInt(24);
					g_Player[client].top10[Stats_DemoFrags] = results.FetchInt(25);
					g_Player[client].top10[Stats_HeavyFrags] = results.FetchInt(26);
					g_Player[client].top10[Stats_EngieFrags] = results.FetchInt(27);
					g_Player[client].top10[Stats_MedicFrags] = results.FetchInt(28);
					g_Player[client].top10[Stats_SniperFrags] = results.FetchInt(29);
					g_Player[client].top10[Stats_SpyFrags] = results.FetchInt(30);
					g_Player[client].top10[Stats_ScoutDeaths] = results.FetchInt(31);
					g_Player[client].top10[Stats_SoldierDeaths] = results.FetchInt(32);
					g_Player[client].top10[Stats_PyroDeaths] = results.FetchInt(33);
					g_Player[client].top10[Stats_DemoDeaths] = results.FetchInt(34);
					g_Player[client].top10[Stats_HeavyDeaths] = results.FetchInt(35);
					g_Player[client].top10[Stats_EngieDeaths] = results.FetchInt(36);
					g_Player[client].top10[Stats_MedicDeaths] = results.FetchInt(37);
					g_Player[client].top10[Stats_SniperDeaths] = results.FetchInt(38);
					g_Player[client].top10[Stats_SpyDeaths] = results.FetchInt(39);
					
					g_Player[client].top10[Stats_BuildingsPlaced] = results.FetchInt(40);
					g_Player[client].top10[Stats_DispensersPlaced] = results.FetchInt(41);
					g_Player[client].top10[Stats_SentryGunsPlaced] = results.FetchInt(42);
					g_Player[client].top10[Stats_TeleporterEntrancesPlaced] = results.FetchInt(43);
					g_Player[client].top10[Stats_TeleporterExitsPlaced] = results.FetchInt(44);
					g_Player[client].top10[Stats_MiniSentryGunsPlaced] = results.FetchInt(45);
					g_Player[client].top10[Stats_SappersPlaced] = results.FetchInt(46);
					g_Player[client].top10[Stats_BuildingsDestroyed] = results.FetchInt(47);
					g_Player[client].top10[Stats_DispensersDestroyed] = results.FetchInt(48);
					g_Player[client].top10[Stats_SentryGunsDestroyed] = results.FetchInt(49);
					g_Player[client].top10[Stats_TeleporterEntrancesDestroyed] = results.FetchInt(50);
					g_Player[client].top10[Stats_TeleporterExitsDestroyed] = results.FetchInt(51);
					g_Player[client].top10[Stats_MiniSentryGunsDestroyed] = results.FetchInt(52);
					g_Player[client].top10[Stats_SappersDestroyed] = results.FetchInt(53);
					
					g_Player[client].top10[Stats_PointsCaptured] = results.FetchInt(54);
					g_Player[client].top10[Stats_PointsDefended] = results.FetchInt(55);
					g_Player[client].top10[Stats_FlagsPickedUp] = results.FetchInt(56);
					g_Player[client].top10[Stats_FlagsCaptured] = results.FetchInt(57);
					g_Player[client].top10[Stats_FlagsStolen] = results.FetchInt(58);
					g_Player[client].top10[Stats_FlagsDefended] = results.FetchInt(59);
					g_Player[client].top10[Stats_FlagsDropped] = results.FetchInt(60);
					
					g_Player[client].top10[Stats_TeleportersUsed] = results.FetchInt(61);
					g_Player[client].top10[Stats_PlayersTeleported] = results.FetchInt(62);
					g_Player[client].top10[Stats_CoatedMilk] = results.FetchInt(63);
					g_Player[client].top10[Stats_CoatedPiss] = results.FetchInt(64);
					g_Player[client].top10[Stats_Coated] = results.FetchInt(65);
					g_Player[client].top10[Stats_Extinguished] = results.FetchInt(66);
					//g_Player[client].top10[Stats_Ignited] = results.FetchInt(XX);
					g_Player[client].top10[Stats_Ubercharged] = results.FetchInt(67);
					g_Player[client].top10[Stats_SandvichesStolen] = results.FetchInt(68);
					
					g_Player[client].top10[Stats_MonoculusStunned] = results.FetchInt(69);
					g_Player[client].top10[Stats_MerasmusStunned] = results.FetchInt(70);
					g_Player[client].top10[Stats_MonoculusFragged] = results.FetchInt(71);
					g_Player[client].top10[Stats_MerasmusFragged] = results.FetchInt(72);
					g_Player[client].top10[Stats_HHHFragged] = results.FetchInt(73);
					g_Player[client].top10[Stats_SkeletonKingsFragged] = results.FetchInt(74);
					
					//g_Player[client].top10[Stats_RobotsFragged] = results.FetchInt(XX);
					g_Player[client].top10[Stats_TanksDestroyed] = results.FetchInt(75);
					g_Player[client].top10[Stats_SentryBustersFragged] = results.FetchInt(76);
					g_Player[client].top10[Stats_BombsResetted] = results.FetchInt(77);
