...
any Native_GetSession(Handle plugin, int params) {
	...
	switch(type)	{
		...
		case SessionType_SentryLVL1Kills: stats = Session[client].SentryLVL1Kills;
		case SessionType_SentryLVL2Kills: stats = Session[client].SentryLVL2Kills;
		case SessionType_SentryLVL3Kills: stats = Session[client].SentryLVL3Kills;
		...
		case SessionType_TeleportersBuilt: stats = Session[client].TeleportersBuilt;
		...
		case SessionType_TeleportersDestroyed: stats = Session[client].TeleportersDestroyed;
